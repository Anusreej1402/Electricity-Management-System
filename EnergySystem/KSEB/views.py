...
def GenerateBill(request, consumer_id):
    try:
        ...
        # Get current date
            ...
            story.append(Paragraph(f"Date: {previous_month_name}", styles['Normal']))
            story.append(Paragraph(f"Month: {current_date}", styles['Normal']))
            ...
            # Assuming office_id is available from somewhere
